    ...
    <>
        ...
        <div className="container mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <Phone size={14} />
              <span>+91 8109591762</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail size={14} />
              <span>info@newabhinavprayas.org</span>
            </div>
          </div>
          <div className="hidden md:block">
            <span className="font-hindi">सामाजिक सेवा में आपका स्वागत है</span>
          </div>
        </div>
      </div>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="font-hindi font-semibold text-lg text-foreground">न्यू अभिनव प्रयास</span>
                <span className="text-xs text-muted-foreground">New Abhinav Prayas</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              {navItems.map((item) => (
                ...
                >
                  <span className="font-hindi font-medium text-foreground group-hover:text-primary">
                    {item.name}
                  </span>
              ...
              <Button variant="default" className="bg-gradient-primary hover:shadow-glow transition-spring">
          ...
          {/* Mobile Menu */}
          {isOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-b border-border shadow-elegant">
